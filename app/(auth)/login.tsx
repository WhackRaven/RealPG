    ...
    <SafeAreaView style={s.container}>
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={s.keyboardView}>
        ...
        <View style={s.content}>
          <FoxMascot message="Schön, dich wiederzusehen!" expression="happy" />

          <Text style={s.title}>Anmelden</Text>
          <Text style={s.subtitle}>Melde dich mit deinem Konto an</Text>
          ...
          <View style={s.form}>
            ...
            <TouchableOpacity style={s.forgotPassword}>
              <Text style={s.forgotPasswordText}>Passwort vergessen?</Text>
            </TouchableOpacity>
          ...
          <View style={s.footer}>
            <Text style={s.footerText}>Noch kein Konto?</Text>
            <TouchableOpacity onPress={() => router.push('/(auth)/register')}>
              <Text style={s.registerLink}>Registrieren</Text>
            </TouchableOpacity>
          </View>
        </View>
...
const stylesLight = StyleSheet.create({
  ...
  forgotPasswordText: { color: '#FF7F24', fontSize: 14, fontWeight: '600' },
  ...
  registerLink: { color: '#FF7F24', fontSize: 14, fontWeight: '700' },
});
